...
elseif strcmp(level,'L2') % Level 2 export
    ...
    PARAM.variables=struct('SLOW_datenum',struct('var_name','SLOW_datenum','dim','profID','unit','Number of days since January 1, 0000','long_name','Measurements starting time (UTC)','data_type','NC_DOUBLE'),...
        ...
        'SLOW_depth',struct('var_name','SLOW_depth','dim','SLOW_dtsec','unit','m','long_name','Water depth','data_type','NC_DOUBLE'),...
        'SLOW_velocity',struct('var_name','SLOW_velocity','dim','SLOW_dtsec','unit','dbar.s^(-1)','long_name','Profiler velocity','data_type','NC_DOUBLE'),...
        'SLOW_temperature',struct('var_name','SLOW_temperature','dim','SLOW_dtsec','unit','°C','long_name','Water temperature','data_type','NC_DOUBLE'),...
        'SLOW_conductivity',struct('var_name','SLOW_conductivity','dim','SLOW_dtsec','unit','μS.cm^(-1)','long_name','Conductivity corrected for temperature sensor response','data_type','NC_DOUBLE'),...
        'SLOW_conductivity20',struct('var_name','SLOW_conductivity20','dim','SLOW_dtsec','unit','μS.cm^(-1)','long_name','Conductivity at 20°C','data_type','NC_DOUBLE'),...
        'SLOW_salinity',struct('var_name','SLOW_salinity','dim','SLOW_dtsec','unit','g.kg^(-1)','long_name','Salinity','data_type','NC_DOUBLE'),...
        'SLOW_density',struct('var_name','SLOW_density','dim','SLOW_dtsec','unit','kg.m^(-3)','long_name','Water density','data_type','NC_DOUBLE'),...
        'SLOW_chlorophyll',struct('var_name','SLOW_chlorophyll','dim','SLOW_dtsec','unit','ppb','long_name','Chlorpohyll','data_type','NC_DOUBLE'),...
        'SLOW_turbidity',struct('var_name','SLOW_turbidity','dim','SLOW_dtsec','unit','FTU','long_name','Turbidity','data_type','NC_DOUBLE'),...
        'SLOW_Incl_X',struct('var_name','SLOW_Incl_X','dim','SLOW_dtsec','unit','°','long_name','Instrument roll angle','data_type','NC_DOUBLE'),...
        'SLOW_Incl_Y',struct('var_name','SLOW_Incl_Y','dim','SLOW_dtsec','unit','°','long_name','Instrument pitch angle','data_type','NC_DOUBLE'),...
        ...
        'FAST_A_x',struct('var_name','FAST_A_x','dim','FAST_dtsec','unit','counts','long_name','Acceleration along the x-axis','data_type','NC_DOUBLE'),...
        'FAST_A_y',struct('var_name','FAST_A_y','dim','FAST_dtsec','unit','counts','long_name','Acceleration along the y-axis','data_type','NC_DOUBLE'),...
