function [BIN,SLOW,FAST] = resolve_turbulence(DATA, kprof, param,folder_out,profID,make_plot_prof,make_plot_spectra,run_dissip,show_progress)
...
%
% T. Doda based on S. Piccolroaz, 10.12.2024
%% Set up parameters
